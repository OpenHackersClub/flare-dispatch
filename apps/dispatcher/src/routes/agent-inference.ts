...
import { modelGateway, type ModelCompletionRequest } from "@flare-dispatch/core";
...
// vitest and out of the non-sandbox bundle. Mirrors @flare-dispatch/core/signals.
import { makeModelGatewayLive } from "@flare-dispatch/runtime-cf/model-gateway";
