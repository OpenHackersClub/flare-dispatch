...
export const recipes: Recipe[] = [
  ...
  },
  {
    ...
    mode: "Action",
    blurb:
      "Hand a deployed URL and a list of user stories in prose; the `product-demo` run attaches Browser Rendering over CDP, records ONE master video while driving the site through each story sequentially, captures key screenshots, and writes a holistic markdown summary a reviewer pastes into the PR.",
    files: [
      { name: "ci.yml", lang: "yaml" },
