// @flare-dispatch/core — the `childRuns` capability (child-Workflow fan-out).
//
...
export class ChildRuns extends Context.Tag("@flare-dispatch/core/ChildRuns")<
  ChildRuns,
  ChildRunsService
>() {}
 ...
 * (`@flare-dispatch/core/primitives`) is the common caller.
 */
