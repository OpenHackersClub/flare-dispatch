// @flare-dispatch/core — the `email` capability (notification email).
//
...
//
// The live binding (`@flare-dispatch/runtime-cf`'s `makeEmailCloudflareLive`)
...
export class Email extends Context.Tag("@flare-dispatch/core/Email")<
  Email,
  EmailService
>() {}
