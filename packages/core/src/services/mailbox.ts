// @flare-dispatch/core — the `mailbox` capability (disposable inbox).
//
...
//
// The live Layer (`@flare-dispatch/runtime-cf`'s `makeMailboxLive`) is backed by
...
export class Mailbox extends Context.Tag("@flare-dispatch/core/Mailbox")<
  Mailbox,
  MailboxService
>() {}
