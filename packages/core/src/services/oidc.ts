// @flare-dispatch/core — the `oidc` capability (Worker self-issued OIDC).
//
...
export class Oidc extends Context.Tag("@flare-dispatch/core/Oidc")<
  Oidc,
  OidcService
>() {}

/** The `oidc` accessor namespace — what runs import from `@flare-dispatch/core`. */
export const oidc = {
  sign: (opts: {
    audience: string;
    subject?: string;
