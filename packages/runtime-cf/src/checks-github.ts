// @flare-dispatch/runtime-cf — ChecksGithubLive: the live `checks` capability.
//
// Backs the `Checks` Context.Tag with the GitHub App check-runs API, via
// `@flare-dispatch/github-app`: an RS256 App JWT is exchanged for a short-lived
...
import { Checks, type ChecksService } from "@flare-dispatch/core";
