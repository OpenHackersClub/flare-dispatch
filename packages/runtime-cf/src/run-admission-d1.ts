// @flare-dispatch/runtime-cf — D1-backed run admission semaphore (issue #109).
//
...
// (`@flare-dispatch/core` run-admission.ts, unit-tested) on what it observed.
// This module is the I/O shell — the atomic SQL.
//
// Spec: ADR #109 (global D1-backed run admission semaphore).

import { Effect, Schedule } from "effect";
import type { AdmissionObservation, AdmissionPool } from "@flare-dispatch/core";
