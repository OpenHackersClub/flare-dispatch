...
The smallest end-to-end slice that proves the model from the [project timeline](timeline.md):
...
If steps 4, 6, 7, and 10 all pass, V0 is complete and the [project timeline](timeline.md) exit criterion is met.
